...
import LiquidGooeyBackground from "@/components/LiquidGooeyBackground";
...
export default function HeroClient({ hero }: HeroClientProps) {
  ...
  return (
    <section className="relative min-h-[100svh] flex flex-col justify-center items-center overflow-hidden pt-24 pb-8 sm:pt-32 md:pt-40 text-center">
      <LiquidGooeyBackground className="z-0" />
